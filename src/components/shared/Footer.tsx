...
const Footer = () => {
    return (
        ...
        <div className="flex gap-5 border-b-[1px] border-b-gray-800 pb-5">
            <div className="w-1/3">
                <Logo/>
            ...
            <div className="w-2/3">
                <div className="grid grid-cols-3 border-b-[1px] border-slate-600 justify-between pb-3 mb-5">
                    <div>
                        <h6 className="text-2xl font-bold mb-3">Contact Us</h6>
                    ...
                    <div>
                        <h6 className="text-2xl font-bold mb-3">Our Email</h6>
                        <div className="flex gap-2 items-center">
                    ...
                    <div>
                        <h6 className="text-2xl font-bold mb-3">Store Location</h6>
                        <div className="flex gap-2 items-center">
                ...
                <div className="grid grid-cols-3">
                    <div>
                        <h6 className="text-2xl font-bold mb-3">Quick Links</h6>
                        <div className="">
                    ...
                    <div>
                        <h6 className="text-2xl font-bold mb-3">Customer Service</h6>
                        <div className="">
                    ...
                    <div>
                        <h6 className="text-2xl font-bold mb-3">Our Shop</h6>
                        <div className="">
