        ...
        <div className="hero min-h-screen">
            <div className="grid grid-cols-2 items-center">
                <div className="w-[80%] mx-auto">
                    ...
                    <h1 className="text-5xl font-bold my-5">The Most Complete Gym equipment and accessories Store</h1>
                    <p className="py-6">
                        Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem
                        quasi. In deleniti eaque aut repudiandae et a id nisi.
                    </p>
                    <button className="btn bg-black text-white my-btn mr-3 hover:text-black">Learn More</button>
                    <button className="btn my-btn">Shop Online</button>
                </div>
